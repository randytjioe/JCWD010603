...
export default function TransactionReport() {
  ...
  const [branchTransactionReportData, setBranchTransactionReportData] =
    useState([]);
  ...
  async function fetchAllProductData() {
    ...
    await axiosInstance
      .get(
        `/api/transaction/transactionReport?startDate=${startDate}&endDate=${endDate}&${sortParam}`
      )
      .then((res) => {
  ...
  async function fetchBranchProductData(branchID) {
    ...
    await axiosInstance
      .get(
        `/api/transaction/branchTransactionReport?startDate=${startDate}&endDate=${endDate}&${sortParam}&branchId=${branchID}`
      )
      .then((res) => {
          ...
          >
            ...
            >
              ...
              >
                <Grid
                  templateColumns={
                    isSmallerThan1500 ? "null" : "repeat(5, 1fr)"
                  }
