...
export default function UserReport() {
  ...
  async function fetchAllProductData() {
    await axiosInstance
      .get(`/api/transaction/userReport?grandTotal=${selectedSortOrder}`)
      .then((res) => {
  ...
  async function fetchBranchProductData(branchID) {
    await axiosInstance
      .get(
        `/api/transaction/branchUserReport?grandTotal=${selectedSortOrder}&branchId=${branchID}`
      )
      .then((res) => {
          ...
          >
            ...
            >
              ...
              >
                <Grid
                  templateColumns={
                    isSmallerThan1500 ? "null" : "repeat(3, 1fr)"
                  }
