...
export default function AdminCategory() {
    ...
    async function categoryConfirmDelete() {
        await axiosInstance.delete(`/admin/delete_category/${categoryId}`).then(() => {
            fetchCategory();
        }).finally(() => {
            setOpenCategoryDialog(false);
        })
    ...
    async function confirmEditCategory() {
        ...
        await axiosInstance.patch(`/admin/update_category/${editCategoryId}`, data).then(() => {
            fetchCategory();
        }).finally(() => {
            setEditDialog(false);
            setEditInput('');
    ...
    async function createCategory() {
        ...
        await axiosInstance.post('/admin/create_category', data)
            .then(() => {
                toast({
